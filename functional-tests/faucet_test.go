...
func TestFaucetSendFunds(t *testing.T) {
	...
	MustStartFaucet(t, faucetctx, api.Address(), owner, faucetDripFil)
	defer faucetcancel()
...
func MustStartFaucet(t *testing.T, ctx context.Context, endpoint string, sourceWallet address.Address, faucetVal uint64) {
